...
#endif // 1
#if 1
	// Một số hàm hỗ trợ làm việc với chuỗi
#if 0
...
#if 0
	// Hàm chuyển các chữ cái hoa về chữ thường
...
#if 0
	// Hàm chuyển ký tự thường lên ký tự hoa
	char name[] = "Le Hong Hai";
	printf("Chuoi trc khi chuyen: %s\n", name);
	strupr(name);
	printf("Chuoi sau khi chuyen: %s\n", name);
...
#if 0
	// Hàm so sánh hai chuỗi. Có phân biệt hoa thường
	char s1[] = "Le Van A";
...
#if 0
	// Hàm tìm chuỗi trong chuỗi (Tìm chuỗi con)
