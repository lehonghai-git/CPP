...
int main()
{
	...
	// Các kiểu Khai báo mảng một chiều
...
+ Chương trình sẽ cấp phát vùng nhớ theo chiều từ địa chỉ cao -> địa chỉ thấp
+ Các mảng a, b, c được cấp phát vùng nhớ = số phần tử * kiểu dữ liệu của mảng (kiểu in là 4 byte)
+ Giữa các vùng nhớ của các mảng a, b, c luôn có một vùng nhớ nhỏ, mang giá trị rác, làm lớp đệm
+ Các vùng ở giữa các mảng (lớp đệm) có kích thước không giống nhau
