/*
** KỸ THUẬT TÌM KIẾM TRONG MẢNG MỘT CHIỀU
*/
#include "NhapXuat.h"
#include "KiemTraSo.h"
#include "TinhToan.h"
...
#if 0
	// Bài 2. Số hoàn thiện, Kiểm tra mảng chẵn
...
#if 0
	// Bài 3. Tìm kiếm một phần tử trong mảng
	int x, vt;
...
#if 0
	// Bài 4. Tìm âm lớn nhất, dương bé nhất
...
#if 0
	// Bài 5. Các giải thuật tìm kiếm cơ bản
#if 0
	// Bài 5.1 Tìm kiếm tuần tự vét cạn
	int x;
...
#if 0
	// Bài 5.2 Tìm kiếm tuần tự lính canh
	int x;
	printf("Nhap vao phan tu muon tim: ");
	scanf("%d", &x);
...
#if 0
	// Bài 5.3 Tìm kiếm nhị phân (VD mảng đã sắp xếp tăng dần)
	int x;
	printf("Nhap vao phan tu muon tim: ");
	scanf("%d", &x);
...
#if 0
	// Bài 6. Max chẵn < Min lẻ trong mảng
