/*
Nhập vào 2 số nguyên dương a, b, (a < b). Thực hiện các yêu cầu
- Đếm xem trong đoạn [a, b] có bao nhiêu số đối xứng, chính phương, nguyên tố
- Tính tổng các số đối xứng, chính phương, nguyên tố tron đoạn [a, b]
*/
#include <stdio.h>
#include <conio.h>
#include <math.h>
