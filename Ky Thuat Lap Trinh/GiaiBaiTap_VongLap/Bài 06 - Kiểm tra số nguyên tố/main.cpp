/*
Nhập vào một số nguyên dương n. Kiểm tra xem số đó có là số nguyên tố hay không
VD số nguyên tố: 2,3,5,7,11,13,17,19,23...
=> Số nguyên tố là số mà chỉ chia hết cho 1 và chính nó
hay nói cách khác là nó chỉ có hai ước số duy nhất là 1 và chính nó
VD số không là số nguyên tố: 4,6,8,9,10...
*/
#include <stdio.h>
#include <conio.h>
#include <math.h>
